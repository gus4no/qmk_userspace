...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT(
    ...
    MT(MOD_LALT, KC_A), MT(MOD_LSFT, KC_R), LT(1, KC_S),         MT(MOD_LGUI, KC_T),   KC_G,                 KC_M,           MT(MOD_RGUI, KC_N), LT(2, KC_E),    MT(MOD_RSFT, KC_I), MT(MOD_RCTL, KC_O),
    KC_Z,               KC_X,               KC_C,                MT(MOD_MEH, KC_D),    KC_V,                 KC_K,           MT(MOD_MEH, KC_H),  KC_COMMA,       KC_DOT,             KC_SLASH,
                                            DRGSCRL,             KC_ENT,               MT(MOD_LSFT, KC_TAB), KC_BSPC,        KC_SPACE
  ),
  [LAYER_LOWER] = LAYOUT(
    KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS,     KC_TRNS,                                 KC_PIPE,        KC_7,           KC_8,           KC_9,           KC_BSLS,
    KC_TRNS, KC_LEFT_SHIFT,  KC_TRNS, KC_LEFT_GUI, KC_TRNS,                                 KC_EQUAL,       KC_4,           KC_5,           KC_6,           KC_MINUS,
    KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS,     KC_TRNS,                                 KC_PLUS,        KC_1,           KC_2,           KC_3,           KC_UNDS,
                             KC_TRNS, KC_TRNS,     KC_TRNS,                                 KC_TRNS,        KC_0
  ),
  [LAYER_RAISE] = LAYOUT(
    KC_TRNS, KC_LBRC,     KC_UP,          KC_RBRC,        KC_MNXT,                                QK_BOOT, KC_TRNS,      KC_TRNS, KC_TRNS,        KC_TRNS,
    KC_TRNS, KC_LEFT,     KC_DOWN,        KC_RIGHT,       KC_MPLY,                                KC_TRNS, KC_RIGHT_GUI, KC_TRNS, KC_RIGHT_SHIFT, KC_TRNS,
    KC_TRNS, KC_VOLD,     KC_MUTE,        KC_VOLU,        KC_MPRV,                                KC_TRNS, KC_RIGHT_ALT, KC_TRNS, KC_RIGHT_CTRL,  KC_TRNS,
