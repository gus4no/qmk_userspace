...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_LOWER] = LAYOUT(
    RESET,   KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS,     KC_TRNS,                                 KC_LBRC,        KC_7,           KC_8,           KC_9,           KC_BSLS,        KC_TRNS,
  ...
  [LAYER_RAISE] = LAYOUT(
    KC_TRNS, KC_TRNS, KC_PGUP,     KC_UP,          KC_PGDN,        KC_MNXT,                                KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS,        KC_TRNS, RESET,
